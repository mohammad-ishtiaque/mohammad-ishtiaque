<h1 align="center">Hi 👋, I'm Kazi Md. Arif Ishtiaq</h1>
...
I'm a Software Engineer specializing in **backend systems** and **applied AI** — building production LLM integrations, RAG pipelines, and automation systems for clients across the US, UAE, UK, and Southeast Asia. I focus on bridging machine learning research with robust, scalable backend architecture.

Currently open to **remote roles** with international teams.
...
**AI / ML:** LangChain, RAG, LLM Integration (Anthropic, OpenAI), Machine Learning
**Database & Infra:** MongoDB, AWS (EC2, Nginx, PM2), Docker
**Automation:** n8n
...
|---|---|---|
| [**university-rag-assistant-system**](https://github.com/mohammad-ishtiaque/university-rag-assistant-system) | RAG-based assistant for university-related queries — document retrieval + LLM-grounded answers | Python, LangChain, RAG |
...
I'm an avid football enthusiast — whether playing on the field or watching the latest matches, football keeps my energy high and my mind sharp.
